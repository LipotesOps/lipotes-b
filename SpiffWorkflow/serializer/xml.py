...
class XmlSerializer(Serializer):
    ...
    def deserialize_assign(self, elem):
        ...
        return Assign(left_attribute=name, right_attribute=value_attribute, right=value)
    ...
    def deserialize_acquire_mutex(self, wf_spec, elem, cls=AcquireMutex, **kwargs):
        ...
        return self.deserialize_task_spec(wf_spec, elem, cls, mutex=mutex, **kwargs)
    ...
    def deserialize_cancel(self, wf_spec, elem, cls=Cancel, **kwargs):
        ...
        return self.deserialize_task_spec(wf_spec, elem, cls, success=success, **kwargs)
    ...
    def deserialize_celery(self, wf_spec, elem, cls=Celery, **kwargs):
        ...
        spec = self.deserialize_task_spec(
            wf_spec,
            elem,
            cls,
            call=call,
    ...
    def deserialize_choose(self, wf_spec, elem, cls=Choose, **kwargs):
        ...
        return self.deserialize_task_spec(
            wf_spec, elem, cls, choice=choice, context=context, **kwargs
        )
    ...
    def deserialize_exclusive_choice(
        self, wf_spec, elem, cls=ExclusiveChoice, **kwargs
    ):
    ...
    def deserialize_execute(self, wf_spec, elem, cls=Execute, **kwargs):
        args = self.deserialize_value_list(elem.find("args"))
        return self.deserialize_task_spec(wf_spec, elem, cls, args=args, **kwargs)
    ...
    def deserialize_gate(self, wf_spec, elem, cls=Gate, **kwargs):
        context = elem.findtext("context")
        return self.deserialize_task_spec(wf_spec, elem, cls, context=context, **kwargs)
    ...
    def deserialize_multi_instance(self, wf_spec, elem, cls=MultiInstance, **kwargs):
        ...
        return self.deserialize_task_spec(wf_spec, elem, cls, times=times, **kwargs)
    ...
    def serialize_sub_workflow(self, spec):
        warnings.warn(
            "SubWorkflows cannot be safely serialized as they only"
    ...
    def deserialize_sub_workflow(self, wf_spec, elem, cls=SubWorkflow, **kwargs):
        warnings.warn(
            "SubWorkflows cannot be safely deserialized as they "
    ...
    def deserialize_merge(self, wf_spec, elem, cls=Merge, **kwargs):
        split_task = elem.findtext("split-task")
        return self.deserialize_task_spec(
            wf_spec, elem, cls, split_task=split_task, **kwargs
        )
    ...
    def deserialize_trigger(self, wf_spec, elem, cls=Trigger, **kwargs):
        ...
        times = self.deserialize_value(elem.find("times"))
        spec = self.deserialize_task_spec(
            wf_spec, elem, cls, context=context, times=times, **kwargs
        )
        try:
