# Generated by Django 2.2 on 2020-06-22 08:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('flow_manage', '0004_remove_processdefinition_application_name'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draf', '草稿'), ('online', '生效'), ('offline', '下线'), ('del', '删除')], default='draft', max_length=32)),
